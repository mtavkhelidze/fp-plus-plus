#ifndef FP_BASE_OPERATORS_COMPOSITION_H
#define FP_BASE_OPERATORS_COMPOSITION_H
#pragma once
...
constexpr auto operator&=(auto&& f, auto&& a) noexcept {
...
#endif  // FP_BASE_OPERATORS_COMPOSITION_H
